document.addEventListener('DOMContentLoaded', () => {
  ...
  const refs = {
    'kim-jensen': {
      ...
      relationship: 'Worked with Jerry on the leadership team at ReMarkets',
    ...
    'brian-socolofsky': {
      ...
      date: 'March 2, 2024',
      relationship: 'Worked with Jerry at Americas Auto Group',
    ...
    'kelly-fleischer': {
      ...
      title: 'An Integrator, with the ability to create alignment across business units and implement people strategies that drive business results',
      date: 'March 6, 2024',
      relationship: 'Worked with Jerry at Syntegra',
    ...
    'ignacio-tamarit': {
      ...
      title: 'Experienced Business Leader/Expertise in Mktng, Ops & Sales across omnichannel in Intl Billing, Payments, Telecom',
      date: 'March 3, 2024',
      relationship: 'Worked with Jerry as a vendor partner in telecom billing',
    ...
    'rolf-koster': {
      ...
      date: 'March 5, 2024',
      relationship: 'Reported to Jerry at Pareteum Corp (2020\u20132022)',
    ...
    'ramu-kambalapuram': {
      ...
      title: 'Entrepreneur | CEO @CloudTem | Building and Scaling Businesses in Generative AI, DevOps, Cloud Services',
      date: 'March 4, 2024',
      relationship: 'Worked with Jerry across several companies over multiple years',
    ...
    'cesar-serrano': {
      ...
      date: 'March 8, 2024',
      relationship: 'Worked with Jerry at Pareteum Corp',
    ...
    'matias-ruiz': {
      ...
      title: 'Chief Administrative Officer @ Skywire Networks | Top Economics Voice | Harvard Leadership',
      date: 'March 2, 2024',
      relationship: 'Worked with Jerry at Pareteum Corp / Skywire Networks',
    ...
    'keith-colfer': {
      ...
      date: 'March 5, 2024',
      relationship: 'Reported to Jerry at Pareteum Corp and Syntegra',
    ...
    'steve-wycoff': {
      ...
      date: 'March 7, 2024',
      relationship: 'Worked alongside Jerry at Americas Auto Group',
    ...
    'shubha-md': {
      name: 'Shubha M.D',
      title: 'Senior Manager QA | Cloud based service testing | API testing and Automation | Kubernetes | Mobile app testing | Test Management',
      date: 'March 6, 2024',
      relationship: 'Worked with Jerry at Syntegra',
